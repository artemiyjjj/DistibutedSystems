...
pid_t create_child_process(const int8_t l_id, struct duplex_chanel_list** const ch, balance_t initial_balance);
...
int wait_for_children(const short child_amount, struct process* const self);
